"""
Django settings for JobJournal project.
...
DEBUG = True if environ["DEBUG"] in ("1", "true", "True") else False
...
WSGI_APPLICATION = "JobJournal.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Job Journal",
    "DESCRIPTION": "API Documentations for the Job Journal",
    "VERSION": "1.0.0",
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=int(environ["ACCESS_TOKEN_LIFETIME"])),
    "REFRESH_TOKEN_LIFETIME": timedelta(
        minutes=int(environ.get("REFRESH_TOKEN_LIFETIME"))
    ),
}
